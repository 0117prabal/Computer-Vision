 ...
 */
float averageAngularError(cv::Mat& estimatedFlow, cv::Mat& flowGroundTruth) {
 ...
 * Lucas-Kanade
 */
void lucasKanade(cv::Mat& IxIx, cv::Mat& IyIy, cv::Mat& IxIy, cv::Mat& IxIt, cv::Mat& IyIt, cv::Mat& flow, int windowDim) {
 ...
 * Horn-Schunck
 */
void hornSchunck(cv::Mat& IxIx, cv::Mat& IyIy, cv::Mat& IxIy, cv::Mat& IxIt, cv::Mat& IyIt, cv::Mat& flow) {
    // matrix definitions
